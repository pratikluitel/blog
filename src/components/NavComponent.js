            ...
            <div className="container-fluid" id="#navigation">
                <nav className="nav nav-sm nav-smol nav-justified d-block d-md-none" id={this.props.typenav}>
                    ...
                    <Collapse isOpen={this.state.isNavOpen} id="Navbar">
                        <ul className="navbar-nav menu">
                            ...
                            <li className="nav-item Contact-marker"><Link className="nav-link" to="#contact">Contact</Link></li>
                ...
                <nav className="nav nav-sm nav-not-sm nav-justified d-none d-md-block d-lg-none">
                    <ul className="navbar-nav">
                        <li className="nav-item Home-marker"><Link className="nav-link" href="/">Home</Link></li>
                        <li className="nav-item Blog-marker"><Link className="nav-link" href="/#main">Blog</Link></li>
                        <li className="nav-item Contact-marker"><Link className="nav-link" href="#contact">Contact</Link></li>
                        <li className="nav-item About-marker"><Link className="nav-link" href="/about">About</Link></li>
                    </ul>
                </nav>
