                    ...
                    <div class="col-10 col-sm-8 offset-1 offset-sm-2">
                        ...
                        <div class="row row-content" style={{marginTop: 30+'px'}}>
                            <div class="text-content">
                                ...
                                <p>This is a blog I started in a desperate attempt to end my long writing hiatus. You probably already know <Link href="/#main">how it panned out</Link>, since you've made it into the ABOUT SECTION.</p>
